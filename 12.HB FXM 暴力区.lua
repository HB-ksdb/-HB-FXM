...
local function isKiller()
    return LocalPlayer.Team and LocalPlayer.Team.Name == "杀手"
end

local function isSurvivor()
    return LocalPlayer.Team and LocalPlayer.Team.Name == "幸存者"
end
...
local function isNearGenerator()
    ...
    for _, obj in ipairs(map:GetDescendants()) do
        if obj:IsA("Model") and obj.Name == "发电机" then
...
local function updateHookESP()
    ...
    safeCall(function()
        ...
        if Config.ESP.ShowOnlyClosestHook then
            ...
            for _, obj in ipairs(map:GetDescendants()) do
                if obj:IsA("Model") and obj.Name == "静电除尘器" then
