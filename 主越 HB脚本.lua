...
local TabHandles = {
    ...
    ER = Tabs.Main:Tab({ Title = "自动发言", Icon = "layout-grid" }),     
    W = Tabs.Main:Tab({ Title = "自瞄瞄准", Icon = "layout-grid" }),     
    E = Tabs.Main:Tab({ Title = "旋转陀螺", Icon = "layout-grid" }),         
